...
public class Vehicle {
	...
	public Vehicle(Long id, String duid, Date last_modification_timestamp, boolean is_deleted, int category,
			String trip_duid,
			int geo_position_status, Date reference_time, double latitude, double longitude, int bearing,
			boolean is_accessible, String pattern_duid, boolean has_bike_rack, long vehicle_number,
	...
	final private Date last_modification_timestamp;
